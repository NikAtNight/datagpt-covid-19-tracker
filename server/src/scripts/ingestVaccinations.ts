		...
		for await (const record of parser) {
			const query = `
					INSERT INTO covid_vaccinations (
						...
						daily_vaccinations,
						total_vaccinations_per_hundred_people,
						people_vaccinated,
					...
					ON CONFLICT (location, date) DO UPDATE SET
						...
						total_vaccinations_per_hundred_people = EXCLUDED.total_vaccinations_per_hundred_people,
			...
			const values = [
				...
				record.total_vaccinations_per_hundred_people || null,
